...
import { createLabOrderSchema } from "@/schemas/createLabOrderSchema";
import type { CreateLabOrderFormData } from "@/schemas/createLabOrderSchema";
...
export function EncounterLabOrderModal({
  ...
  const onSubmit = async () => {
    try {
      // TODO: Add createEncounterLabOrder mutation when API is ready
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  {encounter?.patient?.addresses && encounter.patient.addresses.length > 0 && (
                    <FormField
                          ...
                          <FormControl>
                            ...
                            >
                              ...
                              <SelectContent>
                                ...
                                {encounter.patient.addresses.map((address) => (
                        ...
                        <div className="border border-gray-200 rounded-lg overflow-hidden">
                          ...
                          <div className="divide-y divide-gray-200">
                            {selectedProductVariations.map((item) => (
                              <div
                                key={item.id}
                                className="px-4 py-3 flex gap-4 items-center text-sm"
                              >
                                ...
                                />
                                <div className="w-20 text-gray-900">
                                  ${item.pricePerUnitOverride?.toFixed(2)}
                                </div>
                                <button
                                  type="button"
                                  onClick={() => handleRemoveProduct(item.id)}
                                  className="w-16 text-red-600 hover:text-red-800 text-sm font-medium"
                                >
                                  Remove
                                </button>
                              </div>
